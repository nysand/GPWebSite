...
<div class="container">
    <div class="row">
  		<div class="col-md-9">
            ...
            <div class="col-md-8">
             <form>
               <label class="labeldate">Test: <?php echo $row->test ?? ""?> </label>
               <label class="labeldate">Date: <?php echo $row->date ?? ""?> </label>
               <label class="labeldate">Description: <?php echo $row->description ?? ""?> </label>                              
             </form>
            </div>
          ...
          <div class="col-md-3 sidemenumargin">
            ...
            <div class="sidemenu">
                  ...
                  <a href="results.php" class="active">Results<i class="fas fa-file sidemenuicon"></i></a>
