...
$sql = "SELECT * FROM prescription WHERE userid=:userid";
$stmt = $db->prepare($sql);
...
<div class="container">
    <div class="row">
  		<div class="col-md-9">
            ...
            <div class="col-md-4">
             <form>               
                <label class="Name">Prescription: <?php echo $rows[0]->Name ?? ""?></label><br>
                <label class="ExpDate">Expiry date: <?php echo $rows[0]->Expiry_Date ?? "" ?></label><br>
                <input type="submit" class="btn btn-primary btn-xs" value="Extend"></input><br>
            </form>
          </div>

            <div class="col-md-4">
             <form>               
                <label class="Name">Prescription: <?php echo $rows[1]->Name ?? ""?></label><br>
                <label class="ExpDate">Expiry date: <?php echo $rows[1]->Expiry_Date ?? ""?></label><br>
                <input type="submit" class="btn btn-primary btn-xs" value="Extend"></input><br>
            </form>
          </div>
            ...
            <div class="col-md-4">
             <form>               
                <label class="Name">Prescription: <?php echo $rows[2]->Name ?? ""?></label><br>
                <label class="ExpDate">Expiry date: <?php echo $rows[2]->Expiry_Date ?? ""?></label><br>
                <input type="submit" class="btn btn-primary btn-xs" value="Extend"></input><br>
            </form>
            </div>               
            </div>
          ...
          <div class="col-md-3 sidemenumargin">
           ...
           <div class="sidemenu">
                  ...
                  <a href="prescriptions.php" class="active">Prescriptions<i class="fas fa-sticky-note sidemenuicon"></i></a>
