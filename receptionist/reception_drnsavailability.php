    ...
    <div class="row">
          ...
          <div class="col-md-3 sidemenumargin">      			
            ...
            <p>Main Menu</p>
                  ...
                  <a href="reception_appointments.php">Pacient Appointments<i class="fas fa-book sidemenuicon"></i></a>
                  ...
                  <a href="reception_drnsavailability.php" class="active">Doctors & Nurses Availability<i class="fas fa-user-md sidemenuicon"></i></a>
